...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "activities"),
        "USER": os.environ.get("POSTGRES_USER", "activities"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "activities"),
...
LOGGING = {
    ...
    "loggers":{
        "":{ ##el valor vacio captura todos los modulos de tu proyecto
